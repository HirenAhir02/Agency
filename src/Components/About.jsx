    ...
    <div>
          ...
          <div className='px-4 lg:px-14 max-w-screen-2xl mx-auto my-8 bg-neutralSilver py-16'>
            <div className='flex flex-col md:flex-row justify-between items-center gp-8'>
                ...
                <h2 className='text-4xl text-neutralDgray font-semibold mb-4 md:w-2/3'>Helping a local <span className='text-brandPrimary'>business reinvent itself</span></h2>
                ...
                <div className='md:w-1/2 mx-auto flex sm:flex-row flex-col  sm:items-center justify-around gap-12'>
                    <div className='space-y-8'>
                      <div className='flex items-center gap-4'>
                          <img src="src/assets/compnayIcons/member.png" alt="" />
                          <div>
                       ...
                       <div className='flex items-center gap-4'>
                          <img src="src/assets/compnayIcons/event.png" alt="" />
                          <div>
                    ...
                    <div className='space-y-8'>
                      <div className='flex items-center gap-4'>
                          <img src="src/assets/compnayIcons/clubes.png" alt="" />
                          <div>
                       ...
                       <div className='flex items-center gap-4'>
                          <img src="src/assets/compnayIcons/p.png" alt="" />
                          <div>
